...
let url="https://easy-mock.com/mock/5e79a06c1c4fd747cbb0efe7/mockapi/order/detail"
Mock.mock(RegExp(url+".*"),"get",function(data){
        return Mock.mock({
        "code": 0,
        "message": "",
        "result":{
         "order_sn":"T180324422704080JGJI", 
          "bike_sn":802410001, 
          "mode|1-2":1,
          ...
          "user_name":"@cname",
          "distance":10000,
          "bike_gps":"116.398806,40.0008637",
          "start_time":1521865251000,
          "total_time":224,
          "position_list":[
          {
        "lon": 116.361221,
